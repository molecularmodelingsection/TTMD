...
class graphs:
    ...
    def intraprotein_df(self):
        ...
        ref_bonds = count_hbonds(self.solvprmtop, self.output['eq2']['dcd'], selection, 'protein', 100, 'ref_prot_hbonds')
        
        mp_hbonds = []
        
        for i in self.done_temp:
            mp_hbonds.append([self.solvprmtop, f'../MD/swag_{i}.dcd', selection, 'protein', self.stop_range, f'prot_hbonds_{i}'])

...
class prepare:
    ...
    def complex_in(self, ions_rand):
        complexin = f'''loadAmberPrep ../../r8.prepin
loadAmberPrep ../../s5.prepin
...
loadAmberParams ../../frcmod.r8
loadAmberParams ../../frcmod.s5

PROT = loadpdb {self.receptor}
LIG = loadpdb ligand.pdb

# describe the atoms of interest
#desc LIG.RTP.C9
#desc LIG.STP.C9

# delete atoms and bonds on STP side
deleteBond LIG.STP.H91 LIG.STP.C9
deleteBond LIG.STP.H18 LIG.STP.C9
deleteBond LIG.STP.H17 LIG.STP.C9
deleteBond LIG.STP.C10 LIG.STP.C9

remove LIG LIG.STP.H91
remove LIG LIG.STP.H18
remove LIG LIG.STP.H17
remove LIG LIG.STP.C9

# delete atoms and bonds on RTP side
deleteBond LIG.RTP.H19 LIG.RTP.C9
remove LIG LIG.RTP.H19


bond LIG.STP.C10 LIG.RTP.C9 S
...
exit""")
        ...
        dry_complex = f'''loadAmberPrep ../../r8.prepin
loadAmberPrep ../../s5.prepin
source leaprc.protein.ff14SB
source leaprc.water.tip3p
source leaprc.gaff

...
def calcRMSD(topology, trajectory):
    ...
    # adodaro 
    group_selection = ["(resid 1-307) and name CA",
                       "(resid 308-342) and name CA"]
    R = rms.RMSD(u, u, select='backbone', groupselections=group_selection, ref_frame=0).run() #adodaro 
